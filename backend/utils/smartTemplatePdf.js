...
<tbody>
<tr class="section-row"><td colspan="3">ENSAYOS DE LABORATORIO</td><td></td><td></td><td></td></tr>
{{#each items}}
<tr>
<td>{{codigo}}</td>
<td>{{descripcion}}</td>
...
<li>El cliente debe enviar al laboratorio, para ensayos en suelos, mínimo 30 kg para muestra fina y 70 kg para muestra gruesa.</li>
<li>El cliente debe entregar muestras identificadas.</li>
<li>El cliente debe especificar Norma usada, caso contrario se usará ASTM/NTP vigente.</li>
<li>El cliente entrega muestras en instalaciones LEM, Av. Marañón N° 763, Los Olivos, Lima.</li>
</ul>
</div>
...
<div class="conditions-content">
El plazo de entrega será de los resultados se estima 04 días hábiles, este tiempo está sujeto a la programación enviada por el área de LEM.<br/>
