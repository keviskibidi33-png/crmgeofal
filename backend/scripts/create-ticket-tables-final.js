...
async function createTicketTablesFinal() {
  try {
    console.log('🔧 Creando tablas finales para el sistema de tickets...');
    ...
    console.error('❌ Error creando tablas finales:', error);
  } finally {
    process.exit(0);
  }
}

createTicketTablesFinal();
