...
async function updateTicketSystemTables() {
  try {
    console.log('🔧 Actualizando sistema de tablas para tickets...');
    ...
    const updateTicketsQuery = `
      ...
      -- Renombrar user_id a created_by para consistencia
      ALTER TABLE tickets 
      ...
      -- Renombrar additional_notes a notes si existe
      ALTER TABLE tickets 
      ADD COLUMN IF NOT EXISTS notes TEXT;
