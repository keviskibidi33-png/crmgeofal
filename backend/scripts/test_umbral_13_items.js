...
async function testUmbral13Items() {
  try {
    console.log('🧪 PROBANDO NUEVO UMBRAL DE 13 ITEMS...\n');
    ...
    const testBundle = {
      ...
      project: {
        id: 1,
        name: 'Proyecto de Prueba - 13 Items',
        location: 'Lima, Perú'
      },
      company: {
        id: 1,
    ...
    const outputPath = path.join(__dirname, '..', 'tmp', `test_umbral_13_items_${Date.now()}.pdf`);
    ...
    console.log('\n🔄 Generando PDF con 13 items (nuevo umbral)...');
    ...
    if (fs.existsSync(outputPath)) {
      ...
      console.log('   - ✅ PRIMERA PÁGINA: Solo tabla (sin condiciones)');
      console.log('   - ✅ SEGUNDA PÁGINA: I. CONDICIONES DEL SERVICIO completo');
    ...
    console.error('❌ Error probando umbral de 13 items:', error.message);
