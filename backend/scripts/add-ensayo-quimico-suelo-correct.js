...
async function addEnsayoQuimicoSueloCorrect() {
  try {
    console.log('💾 AGREGANDO ENSAYO QUÍMICO SUELO Y AGUA SUBTERRÁNEO COMPLETO...\n');
    ...
    // 2. Datos completos de ENSAYO QUÍMICO SUELO Y AGUA SUBTERRÁNEO según tus datos
    ...
    console.log('✅ 5 subservicios con códigos SU* agregados');
