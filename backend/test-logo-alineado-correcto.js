...
async function testLogoAlineadoCorrecto() {
  console.log('🧪 VERIFICANDO LOGO ALINEADO CORRECTAMENTE\n');
  
  // Casos de prueba específicos
  const testCases = [
    { count: 25, description: '25 ITEMS: Logo alineado correctamente' },
    { count: 27, description: '27 ITEMS: Logo alineado correctamente' },
    { count: 28, description: '28 ITEMS: Logo alineado correctamente' },
    { count: 30, description: '30 ITEMS: Logo alineado correctamente' },
    { count: 35, description: '35 ITEMS: Logo alineado correctamente' }
  ];
  ...
  for (const testCase of testCases) {
    try {
      ...
      const outputPath = `logo-alineado-correcto-${testCase.count}-items.pdf`;
  ...
  console.log('• .second-page .header: gap: 15px');
  console.log('• .second-page .header img: margin-bottom: 20px');
  console.log('• Logo alineado al mismo margen que las letras');
  console.log('• Gap correcto entre logo y texto');
  console.log('\n✅ VERIFICACIÓN:');
  console.log('• Logo alineado al margen del texto');
  console.log('• Gap correcto entre elementos');
...
// Ejecutar pruebas
testLogoAlineadoCorrecto().catch(console.error);
