-- =====================================================
-- CREAR TABLAS PARA NUEVOS MÓDULOS (VERSIÓN SEGURA)
-- =====================================================
...
-- =====================================================
-- ÍNDICES PARA OPTIMIZACIÓN (SÓLO SI NO EXISTEN)
-- =====================================================
...
-- =====================================================
-- FUNCIONES Y TRIGGERS (SÓLO SI NO EXISTEN)
-- =====================================================

-- Función para actualizar updated_at en templates
...
-- Trigger para templates (solo si no existe)
DO $$
BEGIN
    IF NOT EXISTS (
...
-- Función para actualizar updated_at en shipments
...
-- Trigger para shipments (solo si no existe)
DO $$
BEGIN
    IF NOT EXISTS (
        SELECT 1 FROM pg_trigger 
