...
router.get('/', auth(['admin', 'jefe_laboratorio', 'usuario_laboratorio']), serviceController.getAll);
router.get('/:id', auth(['admin', 'jefe_laboratorio', 'usuario_laboratorio']), serviceController.getById);
router.get('/:id/subservices', auth(['admin', 'jefe_laboratorio', 'usuario_laboratorio']), serviceController.getSubservices);
